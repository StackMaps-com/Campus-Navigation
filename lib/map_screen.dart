...
import 'package:stack_map/pages/student_page.dart'; // Make sure this path is correct for your project
...
class FloorPlanPainter extends CustomPainter {
  ...
  void paint(Canvas canvas, Size size) {
    ...
    // Grid Visualization is still commented out for a cleaner look
    /*
    if (grid != null) {
    ...
    */
    ...
    if (route != null && route!.length >= 2) {
      ...
      _drawIcon(canvas, route![0], locationIcon, iconColor: Colors.green.shade700, iconSize: 28.0);
      _drawIcon(canvas, route!.last, locationIcon, iconColor: Colors.blue.shade700, iconSize: 28.0);
    }
  }
